...
#define PY_HISTOGRAM_FLOAT(BinType, FloatType)                                                                         \
    py::class_<Histogram<BinType, FloatType>>(m, "Histogram_" #BinType "_" #FloatType)                                 \
        ...
        .def("std_moments",                                                                                            \
             (std::vector<double>(Histogram<BinType, FloatType>::*)(py::array_t<FloatType>, uint, bool)) &             \
...
#define PY_HISTOGRAM_UINT(BinType, IntegerType)                                                                        \
    py::class_<Histogram<BinType, IntegerType>>(m, "Histogram_" #BinType "_" #IntegerType)                             \
        ...
        .def("std_moments",                                                                                            \
             (std::vector<double>(Histogram<BinType, IntegerType>::*)(py::array_t<IntegerType>, uint, bool)) &         \
...
#define PY_HISTOGRAM2D_FLOAT(BinType, FloatType)                                                                       \
    py::class_<Histogram2D<BinType, FloatType>>(m, "Histogram2D_" #BinType "_" #FloatType)                             \
        .def(py::init<uint, int, double, uint>(), "nofbins"_a.noconvert(), "n_threads"_a.noconvert(), "max"_a,         \
             "n_hist"_a)                                                                                               \
...
#define MOMENTS(HistType, AbscisseType)                                                                                \
    m.def("std_moments",                                                                                               \
          ...
          "histogram"_a.noconvert(), "bins"_a.noconvert(), "order"_a.noconvert(), "no_clip"_a.noconvert() = false);    \
    m.def("moment",                                                                                                    \
    ...
    m.def("moment",                                                                                                    \
          (double (*)(np_array<HistType> & histogram, np_array<AbscisseType> &, uint, uint, uint64_t, int, bool))(     \
              &moment_py<HistType, AbscisseType>),                                                                     \

...
#define PY_HISTOGRAM_FLOAT(BinType, FloatType)                                                     \
    py::class_<Histogram<BinType, FloatType>>(m, "Histogram_" #BinType "_" #FloatType)             \
        ...
        .def("accumulate", &Histogram<BinType, FloatType>::accumulate_py<FloatType>,               \
             "data"_a.noconvert())                                                                 \
        ...
        .def("std_moments",                                                                        \
             (std::vector<double>(Histogram<BinType, FloatType>::*)(py::array_t<FloatType>, uint,  \
                                                                    bool)) &                       \
...
#define PY_HISTOGRAM_UINT(BinType, IntegerType)                                                    \
    py::class_<Histogram<BinType, IntegerType>>(m, "Histogram_" #BinType "_" #IntegerType)         \
        ...
        .def("std_moments",                                                                        \
             (std::vector<double>(Histogram<BinType, IntegerType>::*)(py::array_t<IntegerType>,    \
                                                                      uint, bool)) &               \
...
#define MOMENTS(HistType, AbscisseType)                                                            \
    m.def("std_moments",                                                                           \
          (std::vector<double>(*)(np_array<HistType> & histogram, np_array<AbscisseType> &, uint,  \
                                  bool))(&std_moments_py<HistType, AbscisseType>),                 \
          "histogram"_a.noconvert(), "bins"_a.noconvert(), "order"_a.noconvert(),                  \
          "no_clip"_a.noconvert() = false);                                                        \
    m.def("moment",                                                                                \
          (double (*)(np_array<HistType> & histogram, np_array<AbscisseType> &, uint, uint64_t,    \
    ...
    m.def("moment",                                                                                \
          (double (*)(np_array<HistType> & histogram, np_array<AbscisseType> &, uint, uint,        \
                      uint64_t, int, bool))(&moment_py<HistType, AbscisseType>),                   \
          "histogram"_a.noconvert(), "bins"_a.noconvert(), "exp_x"_a.noconvert(),                  \
          "exp_y"_a.noconvert(), "n_total"_a.noconvert(), "n_threads"_a.noconvert(),               \
          "no_clip"_a.noconvert() = false);                                                        \
    ...
    m.def("centered_moment",                                                                       \
          (double (*)(np_array<HistType> & histogram, np_array<AbscisseType> &, uint, uint,        \
                      uint64_t, int, bool))(&centered_moment_py<HistType, AbscisseType>),          \
          "histogram"_a.noconvert(), "bins"_a.noconvert(), "exp_x"_a.noconvert(),                  \
          "exp_y"_a.noconvert(), "n_total"_a.noconvert(), "n_threads"_a.noconvert(),               \
          "no_clip"_a.noconvert() = false);

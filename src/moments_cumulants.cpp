...
#define MOMENT(BIN_TYPE, ABSCISSE_TYPE)                                                                      \
	...
	template Multi_array<double, 2> std_2Dmoments(Multi_array<BIN_TYPE, 2>& histogram, Multi_array<ABSCISSE_TYPE, 1>& binx, Multi_array<ABSCISSE_TYPE, 1>& biny, uint order );     \

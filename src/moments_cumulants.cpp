...
#define MOMENT(BIN_TYPE, ABSCISSE_TYPE)                                                            \
    template std::vector<double> std_moments(BIN_TYPE *histogram, ABSCISSE_TYPE *bins,             \
    ...
    template double moment(BIN_TYPE *histogram, ABSCISSE_TYPE *bins, uint n_bins, uint exp_x,      \
                           uint exp_y, uint64_t n_total, int n_threads, bool no_clip);             \
    template double centered_moment(BIN_TYPE *histogram, ABSCISSE_TYPE *bins, uint n_bins,         \
